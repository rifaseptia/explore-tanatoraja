...
export default function NewInstagramPostPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (!instagramPattern.test(formData.postUrl)) {
            setError('Please enter a valid Instagram post URL (e.g., https://www.instagram.com/p/xxxxx/)');
            return;
        }
    ...
    return (
        <div className="max-w-2xl mx-auto">
            ...
            <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                    <h1 className="font-heading font-bold text-2xl text-indigo-900">Add Instagram Post</h1>
                    <p className="text-neutral-500 mt-1">
                        Enter the URL of an Instagram post to embed on the homepage
                    </p>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="bg-white rounded-xl border border-neutral-100 p-6">
                ...
                <div className="mb-6 p-4 bg-gradient-to-r from-pink-50 to-purple-50 rounded-lg border border-pink-100">
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            <p className="text-sm font-medium text-pink-700">How to get Instagram post URL:</p>
                            <ol className="text-xs text-pink-600 mt-1 list-decimal list-inside space-y-1">
                                <li>Open Instagram on web or app</li>
                                <li>Find the post you want to display</li>
                                <li>Tap "..." or "•••" and select "Copy link"</li>
